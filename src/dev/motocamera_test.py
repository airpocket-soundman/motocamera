...
def on_shutter_open(channel):
    global timeLog, threads, number_frame, is_shooting
    #print("GPIO = ",channel ,"shutter, camra_mode = ",camera_mode, number_frame, recording_completed)
...
def get_still_image():
    ...
    still_file_path = share_folder_path + device_name + "{:03}".format(number_cut) + ".jpg"
